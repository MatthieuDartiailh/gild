...
ICON_THEME_POINT = "glaze.icons.icon_theme"

ICON_THEME_EXTENSION_POINT = "glaze.icons.icon_theme_extension"
...
class IconManagerPlugin(HasPreferencesPlugin):
    ...
    current_theme = Str("glaze.FontAwesome").tag(pref=True)

    #: Id of the icon theme to use as fallback if a theme fail to provide an
    #: icon.
    fallback_theme = Str("glaze.FontAwesome").tag(pref=True)
