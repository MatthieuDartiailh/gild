...
# -----------------------------------------------------------------------------
"""Wrapper around the PyQt clipboard that handles Python objects using pickle.
...
from pickle import PickleError, dumps, load, loads
...
class PyMimeData(QtCore.QMimeData):
    ...
    MIME_TYPE = "application/glaze-qt-instance"
    NOPICKLE_MIME_TYPE = "application/glaze-qt-instance"
