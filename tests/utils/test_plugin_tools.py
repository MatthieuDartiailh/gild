...
from glaze.utils.plugin_tools import make_extension_validator

with enaml.imports():
    from enaml.workbench.core.core_manifest import CoreManifest

    from .plugin_tools_testing import (
        PLUGIN_ID,
        Contribution,
        Contributor1,
        Contributor2,
...
class TestExtensionsCollector(object):
    ...
    def test_registation1(self, glaze_qtbot):
    ...
    def test_registration2(self, glaze_qtbot):
    ...
    def test_factory(self, glaze_qtbot):
    ...
    @pytest.mark.ui
    def test_errors1(self, glaze_qtbot):
    ...
    @pytest.mark.ui
    def test_check_errors2(self, glaze_qtbot):
    ...
    def test_check_errors3(self, glaze_qtbot):
    ...
    def test_declared_by(self):
        ...
        assert plugin.contribs.contributed_by("contrib1.contrib") is c.extensions[0]
...
class TestDeclaratorCollector(object):
    ...
    def test_check_errors1(self, glaze_qtbot):
        """Test enforcement of type when using factory."""
    ...
    @pytest.mark.ui
    def test_declarator_failed_registration(self, glaze_qtbot):
    ...
    @pytest.mark.ui
    def test_unsatifiable_requirement(self, glaze_qtbot):
