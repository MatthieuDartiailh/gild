...
def set_preferences(workbench, preferences):
    ...
    """
    plugin = workbench.get_plugin("gild.preferences")
...
def signal_error_raise():
    ...
    from gild.plugins.errors.plugin import ErrorsPlugin
...
def exit_on_err(self):
    """Replacement function for gild.plugins.errors plugin exit_error_gathering.
